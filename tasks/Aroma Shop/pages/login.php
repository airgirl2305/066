	...
	<div class="modal-dialog modal-dialog-centered">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="staticBackdropLabel">Missed you.</h5>
			</div>
			<div class="modal-body">You will be redirected to your account page in a moment.</div>
			<div class="modal-footer">Happy shopping!</div>
		</div>
	</div>
</div>
<!-- Our modal window -->
